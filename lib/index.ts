...
export interface Dizmo {
    ...
    <T>(name: string, condition: string | boolean | number,
        callback: (path: string, value: T, old_value?: T) => void,
        subscribed_callback?: Function,
    ) => UUID;
...
export interface Dizmo {
    addMenuItem:
    (icon_uri: string, text: string, callback: Function) => UUID;
    updateMenuItem:
    (menu_id: UUID, icon_uri: string, text: string, callback: Function) => UUID;
    removeMenuItem:
    (menu_id: UUID) => void;
}
...
export interface Dizmo {
    clone:
    (attributes: Object|undefined, callback?: Function) => void;
}

export interface Dizmo {
    getAttention:
    (options: string | { type: string, duration: number }) => void;
}
...
export interface Dizmo {
    ...
    <T extends Dizmo>() => T[];
    canDock:
    (flag: boolean | (() => boolean) | Dizmo) => void;
    onDock:
    (callback: Function, subscribed_callback?: Function) => void;
    onUndock:
    (callback: Function, subscribed_callback?: Function) => void;
}
...
export interface Dizmo {
    ...
    <T extends Dizmo>() => T;
    setParentDizmo:
    <T extends Dizmo>(other: T) => boolean;
}
...
export interface Dizmo {
    share:
    (remote_host_id: string, callback?: Function) => void;
    unshare:
    (remote_host_id: string, callback?: Function) => void;
}
